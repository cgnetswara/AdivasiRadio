...
import com.anuragShukla06.AdivasiRadio.TransDataCollectionActivity;
...
public class Offline_Translation extends AppCompatActivity {
    ...
    private void downloadAndSave() {
        ...
        int to_download = Question_Download_QUEUE.QUEUE_LIMIT-contentResolver.query(uri, null,null,null,null).getCount();
        String url = TEMP_URL + "fetchQuestionOffline/" + to_download;
