...
public class DataUtils {
    ...
    public static ArrayList<CardDetail> getArticles() {
        ...
        cardDetailArrayList.add(new CardDetail(R.mipmap.ic_launcher_round, "नगेबाई जनेबाई और सोनीबाई गोंडी भाषा में एक गीत सुना रहे है",
                "विधानसभा में अाज हंगामे के बीच 4877 करोड़ 54 लाख 2 हजार 967 करोड़ रुपए का अनुपूरक बजट प्रस्तुत किया गया। अनुपूरक बजट के प्रस्तुत करने के बाद सदन की कार्रवार्ई अाज के लिए स्थगित कर दी गई।"));
